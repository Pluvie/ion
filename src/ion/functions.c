...
#include "functions/chrono_elapsed.c"
#include "functions/chrono_start.c"
#include "functions/chrono_stop.c"
...
#include "functions/str_build.c"
#include "functions/str_builder.c"
