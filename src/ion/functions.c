...
#include <ion/functions/io_exhausted.c>
...
#include <ion/functions/reflect_failure.c>
#include <ion/functions/reflect_initialize.c>
#include <ion/functions/reflect_path_print.c>
