test( json_encode, primitive ) {
  ...
  given("an example struct with primitive types");
    struct example {
      ...
      d32 value_d32;    d64 value_d64;    d128 value_d128;  bool value_bool;
    } example;
  ...
  when("some input data is ready to decode");
    example.value_u8 = 1;
    example.value_u16 = 20;
    example.value_u32 = 300;
    example.value_u64 = 4000;
    example.value_i8 = -1;
    example.value_i16 = -20;
    example.value_i32 = -300;
    example.value_i64 = -4000;
    example.value_d32 = 0.1171875f;
    example.value_d64 = 0.1171875;
    example.value_d128 = 0.1171875;
    example.value_bool = true;
