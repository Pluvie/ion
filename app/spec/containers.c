...
#define list_of int
#define list_eq_function(v, u) v == u
#include <ion/containers/list.c>

#define list_of struct squadmate
#define list_eq_function(v, u) str_equal(v.name, u.name)
#include <ion/containers/list.c>
